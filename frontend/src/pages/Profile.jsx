          ...
          <nav className={`${cardBg} rounded-3xl p-6 w-60 flex flex-col space-y-6 sticky top-20 h-fit`}>
            ...
            <button
                ...
                className={`text-left px-4 py-2 rounded-lg font-semibold transition ${
                    selectedTab === "editProfile" ? "bg-[#f59c9e] text-white" : "hover:bg-[#feeae6] dark:hover:bg-[#e87c7e]"
                }`}
            >
              Edit profile
            </button>
            <button
                ...
                className={`text-left px-4 py-2 rounded-lg font-semibold transition ${
                    selectedTab === "orders" ? "bg-[#f59c9e] text-white" : "hover:bg-[#feeae6] dark:hover:bg-[#e87c7e]"
                }`}
            >
              Orders
            </button>
            <button
                ...
                className={`text-left px-4 py-2 rounded-lg font-semibold transition ${
                    selectedTab === "wishlist" ? "bg-[#f59c9e] text-white" : "hover:bg-[#feeae6] dark:hover:bg-[#e87c7e]"
                }`}
            >
              Wishlist
            </button>
            <button
                ...
                className={`text-left px-4 py-2 rounded-lg font-semibold transition ${
                    selectedTab === "reviews" ? "bg-[#f59c9e] text-white" : "hover:bg-[#feeae6] dark:hover:bg-[#e87c7e]"
                }`}
            >
              Reviews
            </button>
