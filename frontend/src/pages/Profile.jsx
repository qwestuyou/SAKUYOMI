...
export default function Profile() {
    ...
    return (
        <div className={`${styles.bg} min-h-screen`}>
            <Header/>
            <div className="max-w-5xl mx-auto mt-10 flex gap-8 px-4 md:px-0 pb-20">
                    ...
                    {selectedTab === "editProfile" && (
                        <div className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-lg">
                                    <span
                                        className={`font-semibold ${styles.name}`}>Member since:</span> {new Date(user.createdAt).toLocaleDateString()}
                                </p>
                                <button onClick={() => setIsModalOpen(true)}
                                        className={`mt-4 px-6 py-2 rounded-xl shadow-md ${styles.saveBtn}`}>
                                    Edit Info
                                </button>
                            </div>
                        </div>
