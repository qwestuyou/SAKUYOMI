...
export default function UserReviews({ reviews, reviewCardBg }) {
  ...
  // Theme styles for pagination
  const linkActive = reviewCardBg.includes("dark") ? "bg-[#9b5f5f] text-white" : "bg-[#f59c9e] text-white";
  const linkHover = reviewCardBg.includes("dark") ? "hover:bg-[#242424]" : "hover:bg-[#feeae6]";
