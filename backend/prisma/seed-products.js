...
async function main() {
    await prisma.product.createMany({
        data: [
            ...
            { name: 'Chainsaw Man Vol.4', price: 299, description: 'Rev up with Denji’s chaotic demon-hunting in this wild manga volume.', categoryId: 1, image: 'https://m.media-amazon.com/images/I/91-gKvmZkNL._AC_UF350,350_QL80_.jpg', inStock: tfalse },
            ...
            { name: 'Luffy Funko', price: 1200, description: 'Sail with Luffy in this vibrant One Piece Funko!', categoryId: 7, image: 'https://www.gamers.sk/content/product_instances_cover/Konzolvilag_1/1401844/ajandektargyak-funko-pop-98-animation-one-piece-monkey-d-luffy-vinyl-figure.jpgs', inStock: true },
